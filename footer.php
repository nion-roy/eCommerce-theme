    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-12 col-lg-4">
                <h6 class="mb-4 text-white">About Company</h6>
                <div class="row">
                    <div class="col-12">
                        <div> Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, distinctio.</div>
                        <div class="mt-2">
                            <span><i class="bi bi-geo-alt-fill me-2"></i>19/5 Primary Road, Kallyapur, Dhaka - 1207</span> </br>
                            <span><i class="bi bi-envelope-fill me-2"></i>nion.roy22@gmail.com</span></br>
                            <span><i class="bi bi-telephone-outbound-fill me-2"></i>+8801761-115624</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-4 align-items-center">
                <div class="col-md-6">
                    <span class="small text-muted">
                        Powered by <a href="niondev.xyz">Nion Roy</a>.
                    </span>
                </div>
