                                            ...
                                            <div class="col-md-8 col-12 flex-grow-1">
                                                ...
                                                <div class="mt-6">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <a href="shop-wishlist.html" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist">
                                                            <i class="bi bi-heart"></i>
                                                        </a> 
                                                    </div>
                                                    <div class="mt-3 d-flex align-items-center gap-2">
                                                        <button data-bs-toggle="modal" data-bs-target="#checkoutModal" class="btn btn-primary hover-border w-25 rounded-0 px-0"> <i class="feather-icon icon-shopping-bag me-1"></i>Buy Now </button>
                                                        <a href="#!" class="btn btn-primary hover-border w-auto rounded-0"><i class="feather-icon icon-shopping-cart"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
