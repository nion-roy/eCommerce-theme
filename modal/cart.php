<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                <a href="#" class="text-inherit">
                                    <h6 class="mb-2">Haldiram's Shev Bujia Haldiram's Shev Bujia </h6>
                                </a>
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <span class="fs-4 fw-bold">$20.00</span>
        </div>
    </div>

    <div class="footer-btn text-center">
        <button id="springButton" data-bs-toggle="modal" data-bs-target="#checkoutModal" class="btn btn-primary border-inset hover-border w-100 rounded-0 mb-3 py-3 fs-5">
            <i class="feather-icon icon-shopping-cart me-1 fw-bold"></i>
            ক্যাশ অন ডেলিভারিতে অর্ডার করুন
        </button>
        <a class="text-decoration-underline" href="shop-cart.php">View Cart</a>
    </div>
