         ...
         <div class="row w-100 align-items-center gx-lg-2 gx-0 justify-content-between">
            <div class="col-xxl-2 col-lg-2 col-md-6 col-5">
               <a class="navbar-brand d-none d-lg-block" href="index.php">
                  <img src="assets/images/logo/freshcart-logo.svg" style="width: 150px" alt="eCommerce HTML Template" />
               </a>
            ...
            <div class="col-xxl-3 col-lg-3 col-md-6 col-5 d-none d-lg-block">
               <ul class="navbar-nav gap-3" style="flex-direction: inherit !important">
                  <li class="nav-item">
            ...
            <div class=" col-xxl-2 col-lg-2 text-end col-md-6 col-7">
               <div class="list-inline">
                  <div class="list-inline-item me-5">
                     <a href="shop-wishlist.php" class="text-muted position-relative">
