...
!(function () {
	...
	s && e(s, { infinite: !0, slidesToShow: 1, slidesToScroll: 1, autoplay: !0, dots: !0, arrows: !1 });
	(s = document.querySelectorAll(".slider-8-columns")),
		...
		s && $(s).slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, fade: !0, asNavFor: ".slider-nav" }),
		(s = document.querySelector(".slider-nav")),
		s && $(s).slick({ slidesToShow: 4, slidesToScroll: 1, asNavFor: ".slider-for", dots: !1, centerMode: !1, focusOnSelect: !0, prevArrow: '<span class="slick-prev"><i class="feather-icon icon-chevron-left"></i></span>', nextArrow: '<span class="slick-next"><i class="feather-icon icon-chevron-right"></i></span>' }),
